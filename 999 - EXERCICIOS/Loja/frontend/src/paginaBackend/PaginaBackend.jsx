...
export default function PaginaBackend() {
    ...
    return (
        <>
            ...
            <form class="row g-3 needs-validation" noValidate onSubmit={handleSubmit} id='formulario_criar_produto'>
                <div class="col-md-4">
                ...
                <div className="valores">
                    <div class="col-md-4" id='valor'>
                        ...
                        <div class="input-group has-validation">
                            ...
                            <input type="number" class="form-control" id="antigoValorData" aria-describedby="inputGroupPrepend" placeholder='valor antigo' required />
                    ...
                    <div class="col-md-4" id='valor'>
                        ...
                        <div class="input-group has-validation">
                            <span class="input-group-text" id="inputGroupPrepend">R$</span>
                            <input type="number" class="form-control" id="atualValorData" aria-describedby="inputGroupPrepend" placeholder='valor atual' required />
                            <div class="invalid-feedback">
